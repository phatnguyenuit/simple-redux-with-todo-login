import { filters, prefixIdTodo } from "../../api/data";
...
export default class Todo extends React.Component {
  ...
  handleSave = (id, values) => {
    ...
    this.toggleEditable();
    dispatch(todoAction.actionUpdateTodo(id, values));
    dispatch(tagAction.actionAddTag(values.tags));
  };
  handleCancel = () => {
    this.toggleEditable();
  };
  render() {
    ...
    const renderComponent = editable ? (
      <TodoEditable {...childProps} />
    ) : (
      <TodoDisplay {...childProps} />
    );
