...
export default props => {
  ...
  const searchTodo = query => {
    dispatch(todoAction.actionSearchTodo(query));
  };
  ...
  const logout = e => {
    e.preventDefault();
    dispatch(authenticationAction.actionLogout());
          ...
          {user && (
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                <Link className="dropdown-item" to="/not-match">
                  Not match
                </Link>
                <Link className="dropdown-item" to="/another-not-match">
                  Another not match
                </Link>
                <div className="dropdown-divider" />
                <span
                  className="dropdown-item btn btn-danger pointer"
                  role="button"
                  onClick={logout}
                >
                  Log Out
